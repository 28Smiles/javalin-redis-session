 ...
 * @since 11.05.2022
 */
class AdvancedCompressionCodecTest {
    @Test
    fun testCompressor() {
        val compressor = AdvancedCompressionCodec()
        val byteBuffer = ByteBuffer.wrap(
            ("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor " +
                ...
                "ipsum dolor sit amet. Duis autem vel eum iriure dolor in hendrerit in vulputate velit " +
                ...
                "zzril delenit augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta " +
                "nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim " +
                "assum. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh " +
                ...
                "esse molestie consequat, vel illum dolore eu feugiat nulla facilisis. At vero eos et " +
                "accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata " +
                "sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur").toByteArray()
        )
        val compressed = compressor.encodeValue(byteBuffer)
        val decompressed = compressor.decodeValue(compressed)

        Assertions.assertEquals(
            byteBuffer.array().toString(Charset.defaultCharset()),
            decompressed?.array()?.toString(Charset.defaultCharset()),
        )
    }

    @Test
    fun testCompressorSmall() {
        val compressor = AdvancedCompressionCodec(minPayloadBytes = 0)
        val byteBuffer = ByteBuffer.wrap(
            ("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor " +
                "invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et " +
                "accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata " +
                "sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing " +
                "elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, ").toByteArray()
        )
        val compressed = compressor.encodeValue(byteBuffer)
        val decompressed = compressor.decodeValue(compressed)
